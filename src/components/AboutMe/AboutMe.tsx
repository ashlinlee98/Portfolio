const About = () => {
    return (
        <section id="about">
            <h2 className="lg:mt-24 mt-48 ml-20 lg:text-5xl text-3xl px-10 md:px-16 py-10">About Me</h2>
            
            <div className="lg:flex justify-between items-center lg:px-12 lg:pb-10">
                
                <img src="./../../../images/hydePark.jpg" alt="sunset photo in Hyde Park, London" className="w-96 rounded-lg lg:border-solid lg:border-8 lg:border-yellow-500 lg:ml-4" />
