...
const Project = ({ title, image, liveLink, githubLink }: ProjectProps) => {
    return (
        <div className="relative group">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center text-white space-y-2 z-5 opacity-100 group-hover:opacity-100 transition duration-300">
                <a
                    href={liveLink}
